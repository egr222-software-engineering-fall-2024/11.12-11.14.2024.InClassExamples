...
//        List<String> words = new LinkedList<>();
        ...
        // repeatedly remove the first word in the list until all the words are removed.
        while (!words.isEmpty()) {
            words.remove(0);
        }

        // instead of removing all words at the beginning of the list, remove every other word.
//        removeEveryOtherWordNotUsingAnIterator(words);
//        removeEveryOtherWordUsingAnIterator(words);
...
//        printFile(words);
    ...
    public static void removeEveryOtherWordNotUsingAnIterator(List<String> words) {
    ...
    // This is an alternate version of the method created as part of video 11-1 (Code Along 11-A)
    // that uses an ITERATOR to improve performance
    public static void removeEveryOtherWordUsingAnIterator(List<String> words) {
